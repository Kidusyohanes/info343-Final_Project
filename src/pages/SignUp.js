...
// this is a page for an user to sign up for character animator
// the user has to enter email, password, reenter password, and username
// then it will record the user into database
                        ...
                        <div>
                            <button className="btn btn-primary mr-2" disabled={this.state.disabled} onClick={() => {
                                this.props.handleSignUp(this.state.email,
                                    this.state.password, this.state.username, (errorMessage) => {
